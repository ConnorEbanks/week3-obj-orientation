...
favoriteThings['show'] = 'The Last Kingdom'
console.log(favoriteThings)
...
const harry = new Wizard('Harry', 27, 'The spell..')
...
let phoneOne = new Phone('Apple', 'iPhone', 128, 'white', 1000)
let phoneTwo = new Phone('Samsung', 'Galaxy S21', 256, 'green', 1200)
let phoneThree = new Phone('OnePlus', 'OnePlus 9 5G', 128, 'blue', 800)
...
const myFirstMotorcycle = new Motorcycle(1, 'blue', 150, 'Honda', true)
